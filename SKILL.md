...
- You need to determine this / next week's writing portfolio from a Notion topic database or local files.
...
- Ranking purely by buzz, a single number, or headline spreadability.
